...
export default function RegisterSeller({ setFieldValue }) {
            ...
            <View style={RegisterStyle.container}>
                <ScrollView>
                    ...
                    <View style={RegisterStyle.titleContainer}>
                        ...
                        <Text style={RegisterStyle.smallText}>Trở thành người bán mới!</Text>
                    </View>
                        ...
                        {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                            ...
                            < View style={[RegisterStyle.inputContainer]}>
                                ...
                                <View>
                                    ...
                                    <Text style={RegisterStyle.abvInput} >Tên người bán</Text>
